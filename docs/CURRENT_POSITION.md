...
| V2 modules (M11–M22) | 🟢 CI reported green on `f475589…`; this documentation commit is a *new* tip and does not inherit that CI run |
...
Identify the evidence artifact that still carries `source_tip = 8245e3f…` and classify HISTORICAL vs intended CURRENT. Do not hand-edit the SHA. Do not weaken the freshness test. Do not treat this documentation commit as Foundation PASS.
